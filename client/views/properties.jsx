...
import NewFrameProbabilitySelector from './newFrameProbabilitySelector';
...
export default class Properties extends React.Component {
  static propTypes = {
    ...
    newFrameHandler : React.PropTypes.func.isRequired,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <NewFrameProbabilitySelector setNewFrameProbability={this.props.newFrameHandler}
                                     spawnRate={this.props.newFrameRate}/>
